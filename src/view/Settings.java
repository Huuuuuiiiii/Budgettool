...
public class Settings extends JPanel implements ActionListener{
	...
	public Settings(ViewHandler mainPanel) {
		...
		personButton = Components.createButtom("Person hinzufÃ¼gen");
		...
		kategorieButton = Components.createButtom("Kategorie hinzufÃ¼gen");
		...
		waerungLabel = Components.createLabel("WÃ¤hrung", 20, 36, 100, 14);
